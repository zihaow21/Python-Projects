...
conversations = None
du = DataUtils(conversations, 5, 5, 7, 1000, data_dir)  # DataUtils(conversations, maxLength, maxLengthEnco, maxLengthDeco, batchSize)
# du.createCorpus()
# du.saveData()
du.loadData()
...
seq2seq = Seq2seq(epochs=5, learning_rate=0.005, batch_size=1000, source_vocab_size=source_vocab_size,
                  target_vocab_size=target_vocab_size, maxLengthEnco=5, maxLengthDeco=7, num_softmax_samples=64,
                  embedding_size=25, hidden_size=64, num_layers=3, use_lstm=False, model_dir=model_dir,
