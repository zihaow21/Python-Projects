...
conversations = None
du = DataUtils(conversations, 10, 10, 12, 500, data_dir)  # DataUtils(conversations, maxLength, maxLengthEnco, maxLengthDeco, batchSize)
# du.createCorpus()
# du.saveData()
# du.loadData()
...
seq2seq = Seq2seq(epochs=100, learning_rate=0.005, batch_size=1000, source_vocab_size=source_vocab_size,
                  target_vocab_size=target_vocab_size, maxLengthEnco=10, maxLengthDeco=12, num_softmax_samples=64,
                  embedding_size=50, hidden_size=64, num_layers=3, use_lstm=False, model_dir=model_dir,
